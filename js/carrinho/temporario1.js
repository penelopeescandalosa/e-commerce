add_on_load_all(function() {
        if(window.location.hash != '#carrinho'){
            temporario1();
            inicia_copiar_texto_observacoes();
            inicia_alteracao_no_envio();
    ...
    function temporario1(){

        if($('#payment').length == 0){
            setTimeout(temporario1, 1000);
            //console.log('temporario1() adiado.');
            return;
        }else{
            //console.log('temporario1() executado.');
        }
  ...
  $(document).on('click resize', function(){
    ...
    /* function inicia_copiar_texto_observacoes(){
        ...
        if($('#order-customer-note').length == 0){
            setTimeout(inicia_copiar_texto_observacoes, 1000);
            console.log('inicia_copiar_texto_observacoes() adiado.');
            return;
        }else{
            console.log('inicia_copiar_texto_observacoes() executado.');
        }
    ...
    function inicia_alteracao_no_envio(){
        ...
        if($('div[data-checkout-template="shipping"]').length == 0){

            setTimeout(inicia_alteracao_no_envio, 1000);
            //console.log('inicia_alteracao_no_envio() adiado.');
            return;

        }else{
            //console.log('inicia_alteracao_no_envio() executado.');
        }
